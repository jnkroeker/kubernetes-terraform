...
# each instance's internal IP will be used to advertise the API Server to members of the cluster
...
# create the systemd unit file for kube controller manager
...
# create kube-scheduler.yaml config file
